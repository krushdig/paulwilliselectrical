...
return array(
	...
	"params" => array(
		...
		array(
			...
			'icon' => '<i class="fa fa-desktop"></i>',
			'edit_field_class' => 'vc_col-sm-3 vc_column',
			'description' => __( 'Leave empty to use large font size. Tablet and mobile font sizes are optional.', 'the7mk2' ),
			'group' => __( 'Testimonial', 'the7mk2' ),
		),
		...
		array(
			...
			'icon' => '<i class="fa fa-desktop"></i>',
			'edit_field_class' => 'vc_col-sm-3 vc_column',
			'description' => __( 'Leave empty to use large line height. Tablet and mobile font line heights are optional.', 'the7mk2' ),
			'group' => __( 'Testimonial', 'the7mk2' ),
		),
